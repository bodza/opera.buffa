...
(defn charts [css]
    ...
    [:li #_[:a {:href "anno/line.html"} "line.html"]
    ...
    [:li #_[:a {:href "anno/spline.html"} "spline.html"]
    ...
    [:li #_[:a {:href "anno/line-stacked.html"} "line-stacked.html"]
    ...
    [:li #_[:a {:href "anno/spline-stacked.html"} "spline-stacked.html"]
    ...
    [:li #_[:a {:href "anno/line-percent.html"} "line-percent.html"]
    ...
    [:li #_[:a {:href "anno/spline-percent.html"} "spline-percent.html"]
    [:p "Ugyanez spline finomítással. Detto."]
    [toggle charts/-spline-percent]]

    [:li #_[:a {:href "anno/area.html"} "area.html"]
    ...
    [:li #_[:a {:href "anno/area-spline-stacked-sum10.html"} "area-spline-stacked-sum10.html"]
    ...
    [:li #_[:a {:href "anno/spline-percent-sum10.html"} "spline-percent-sum10.html"]
    [:p "Most ugyanez vonalasan, százalákosan: nekem tecccik."]
    [toggle charts/-spline-percent-sum10]]

    [:li #_[:a {:href "anno/area-spline-percent-sum10.html"} "area-spline-percent-sum10.html"]
    [:p "Területi kitöltéssel: még inkább teccik."]
    [toggle charts/-area-spline-percent-sum10]]

    [:li #_[:a {:href "anno/pie.html"} "pie.html"]
    ...
    [:li [:a {:href "anno/pie-drilldown-ordered-3d.html"} "pie-drilldown-ordered-3d.html"]
    [:p "Forgassuk be térbe és lyukasszuk ki a közepét: wowwww!"]
    [toggle charts/-pie-drilldown-ordered-3d]]

    [:li [:a {:href "anno/pie-drilldown-ordered-min5.html"} "pie-drilldown-ordered-min5.html"]
    ...
    [:li [:a {:href "anno/pie-drilldown-ordered-min5-3d.html"} "pie-drilldown-ordered-min5-3d.html"]
    [:p "Mindez térben."]
    [toggle charts/-pie-drilldown-ordered-min5-3d]]

    [:li [:a {:href "anno/pie-donut.html"} "pie-donut.html"]
    [:p "A végére édesség: fánk! Kicsit egymásra másznak címkék, nem jöttem rá hamar, majd egyszer."]
    [toggle charts/-pie-donut]]

    [:li [:a {:href "anno/column-drilldown-ordered-min5.html"} "column-drilldown-ordered-min5.html"]
    ...
    [:li [:a {:href "anno/column-drilldown-ordered-min5-3d.html"} "column-drilldown-ordered-min5-3d.html"]
    [:p "Forgassuk térbe! Még mindig kattinthatóan."]
    [toggle charts/-column-drilldown-ordered-min5-3d]]

    [:li [:a {:href "anno/column-drilldown-ordered-min5-3d-slider.html"} "column-drilldown-ordered-min5-3d-slider.html"]
    [:p "Most aztán forgathatod Te is! Még mindig kattinthatóan."]
    [toggle charts/-column-drilldown-ordered-min5-3d-slider]]

    [:li [:a {:href "anno/column-drilldown-inverted.html"} "column-drilldown-inverted.html"]
    ...
    [:li #_[:a {:href "anno/column-stacked-3d.html"} "column-stacked-3d.html"]
    [:p "Most rétegezzük az oszlopokat. Térben."]
    [toggle charts/-column-stacked-3d]]

    [:li #_[:a {:href "anno/column-stacked-3d-verso.html"} "column-stacked-3d-verso.html"]
    [:p "Mint előbb és ha megfogod a bal egérgombbal, még forgathatod is! Yuck!"]
    [toggle charts/-column-stacked-3d-verso]]

    [:li #_[:a {:href "anno/scatter.html"} "scatter.html"]
    ...
    [:li #_[:a {:href "anno/scatter-3d.html"} "scatter-3d.html"]
    ...
    [:li #_[:a {:href "anno/bubble.html"} "bubble.html"]
    ...
    [:li #_[:a {:href "anno/bubble-map.html"} "bubble-map.html"]
    ...
    [:li #_[:a {:href "anno/heatmap.html"} "heatmap.html"]
    ...
    [:li #_[:a {:href "anno/tree.html"} "tree.html"]
    [:p "Nem csak népességfa lehet ilyen szerkezetű, hanem felekezeti-fa is."]
    [toggle charts/-tree]]

    [:li #_[:a {:href "anno/tree-pie.html"} "tree-pie.html"]
    ...
    [:li #_[:a {:href "anno/pie-3d-ortus.html"} "pie-3d-ortus.html"]
    ...
    [:li #_[:a {:href "anno/pie-3d-offic.html"} "pie-3d-offic.html"]
    [:p "Ugyanez a foglalkozások szerint."]
    [toggle charts/-pie-3d-offic]]

    [:li #_[:a {:href "anno/bar-offic.html"} "bar-offic.html"]
    ...
    [:li #_[:a {:href "anno/heatmap-typo.html"} "heatmap-typo.html"]
    [:p "Forrástipológia-hőtérkép. Győzött a hagyatéki összeírás."]
    [toggle charts/-heatmap-typo]]

    [:li #_[:a {:href "anno/seneca-ortus.html"} "seneca-ortus.html"]
    ...
    [:li #_[:a {:href "anno/seneca-religio.html"} "seneca-religio.html"]
    [:p "A legtöbben katolikusok olvasták Seneca műveit, főleg a 17. század 3. negyedében,
    vagy csak ebbe az irányba torzít a jegyzékek jelen összeállítása."]
    [toggle charts/-seneca-religio]]

    [:li #_[:a {:href "anno/mokka-r-cent.html"} "mokka-r-cent.html"]
    ...
    [:li #_[:a {:href "anno/mokka-r-bibl.html"} "mokka-r-bibl.html"]
    ...
    [:li #_[:a {:href "anno/mokka-r-datum.html"} "mokka-r-datum.html"]
    ...
    [:li #_[:a {:href "anno/mokka-r-innen.html"} "mokka-r-innen.html"]
    [:p "Hőtérkép határon innen."]
    [toggle charts/-mokka-r-innen]]

    [:li #_[:a {:href "anno/mokka-r-onnan.html"} "mokka-r-onnan.html"]
    ...
    [:li #_[:a {:href "anno/humanus-099a.html"} "humanus-099a.html"]
    [:p "Majd a feldolgozás jellege/foka."]
    [toggle charts/-humanus-099a]]

    [:li #_[:a {:href "anno/humanus-creat8-modif5.html"} "humanus-creat8-modif5.html"]
    ...
    [:li #_[:a {:href "anno/humanus-creat-modif.html"} "humanus-creat-modif.html"]
    [:p "Tényleges létrehozások és módosítások száma szerkesztői napló alapján."]
    [toggle charts/-humanus-creat-modif]]

    [:li [:a {:href "anno/pie-pie.html"} "pie-pie.html"]
    [:p "Bonus."]
